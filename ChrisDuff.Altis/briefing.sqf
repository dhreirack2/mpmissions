...
player createDiarySubject ["arma3life","ArmA 3 Life Rules"];
	...
	player createDiaryRecord ["serverrules",
		[
			"Random Deathmatching (RDM)", 
				...
				5. Killing someone in an attempt to protect yourself or others is not RDMing, however you must first declare.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule", 
				...
				1. If you are killed you CANNOT return to the scene. Your on a NEW LIFE. You can't return to the bank, chase the person that stole your car, etc.<br/>
				...
				4. If you manually respawn, it is not a new life. This will also be considered combat logging and you will see huge punishments.(Alt+F4, etc)<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Don't Be A Dick!", 
				...
				Just don't ruin other peoples roleplay experience. This will be taken as a heavy offense.<br/>
...
// Police Section
	player createDiaryRecord ["policerules",
		[
			"Crisis Negotiation",
				"
				Crisis Negotiation must be handled by the highest online PD member.br/><br/>
				"
		]
	];
	player createDiaryRecord ["policerules",
		[
			"The Federal Reserve",
				"
				1. Civilians can enter the bank, but going to the vault room is illegal.<br/>
				2. Landing near/on the bank.<br/>
				2. If the bank is getting robbed police must send as many police there as possible. You don't have long.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Aviation",
				"
				1. You can only land on helipads or open fields outside towns.<br/>				
				...
				6. Helicopters cannot land at Police HQ's.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Checkpoints", 
				...
				1. A checkpoint must consist of 4 or more police, one of which must be sergeant utilizing 2 or more vehicles. An ATV does not count as one of the required vehicles, but may still be used.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Weapons", 
				...
				All weapons bought from the gun store, however you must have the license.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				...
				7. If the raid is a failure (All officers die), the 20 minute timer still applies to those officers.<br/>
				8. Backup may be called in, but it may not consist of fallen officers (see 'New Life Rule').<br/><br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Weapons",
				...
				1. Any weapons from the rebel outpost or a gun without a license.<br/>
				2. Police items.<br/>
				"
		]
	];
...
// Controls Section
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				Tab ( Mining ) hotkey <br/>
				"
		]
	];

	player createDiaryRecord["arma3life",
		[
			"Outline",
				"
				Official Rule Arma 3 Life – Must Read and comply before playing in server<br/>
				Failure to role play in the server no matter what the excuse will result in a permanent ban or 1 – 2 hour jail time. Depending on the extent of the rule breaking, and admins choice.<br/>
				Anyone cheating, duping, or using glitches in the game will be banned permanently and information will be sent to BOI.<br/>
				Again please realize this is a role playing game. Some scenarios you may be placed in may include some adult content. In saying that realize serious abusive attitude toward others will not be allowed, nor will any constant fighting<br/>
				Administration’s decisions are final – No excuses.<br/>
				We require you have a microphone here in Arma 3 Life. If you don’t have a mic, take a hike.<br/>
				"
		]
	];
	...
	player createDiaryRecord["arma3life",
		[
			"Rules",
				"
				    1. No using global or side chat voice com.<br/>
					2. If you have an issue please wait in helpdesk don’t spam admins for help in game or in teamspeak. We promise we do all in our powers to help everyone as quick as possible.<br/>
					3. Disrupting our gameserver with stupid, immature behavior is not permitted. Anyone found doing so will be removed – includes spamming, taunting other players, RDM, and VDM.<br/>
					4. No crime is allowed in the safezone. Safezones are as followed 50m around any Car shop, Garage, ATM’s, EMT Base, and Civ Spawns.<br/>
					5. While in game, you are to be in character. This is a hardcore RP server, and we expect you to RP to the fullest extent. If you fail to RP, you will be removed from our Arma 3 Life server.<br/>
					6. There is no point in killing anyone so please role play you cannot loot gear anyways. You can take someone hostage and tell them to put their gear on the floor.<br/>
					7. The NLR (New Life Rule) is as follows, You die, fully die as in respawn. You forget all details that led up to your death (Killer, location, etc). You are not to return to your death site for a 1km radius circle around. Unless in the city then it would be 500m. Until the situation is over you are not allowed to go back to that area no matter what the circumstances.<br/>
					8. If you are interested in RP’ing a Lawyer, or Public Defender, you are required to be in a business suit, or at least a shirt and tie. You cannot show up in a full rebal uniform, trying to be a lawyer. You also must not be wanted for any crimes against you.<br/>
					9. You are not allowed to VDM. In a RP situation if you’re being robbed by someone standing right in front of your vehicle and they threaten your life, you are able to hit the gas. Otherwise you are not too purposely VDM and aim and go after someone with your vehicle.<br/>
					10. RDM is not allowed in this server and can end in permanent Ban. No if ands or buts allowed when it comes to RDM. Just don’t do it.<br/>
					11. Any Player that have been revived by a medic – must go with the medics to the hospital to continue role-playing. They cannot reengage in the activities that cause the revive no matter the reason. Even accidental deaths, vdm, rdm, etc. Failure to comply will end in a 24hr Ban from the server.<br/>
					12. Using the tow truck in a way that is not intended to be used: eg. Towing a box truck to double your payload is not allowed. The tow truck however can be used to remove vehicles from an accident, pull vehicles out of the mud, bring to police to impound, or steal.<br/>
					13. Robbing the bank with under 8 cops online is not allowed.<br/>
					14. Stealing EMS Vehicles / destroying their cars is not allowed. Only EMS can drive EMS vehicles, do not hinder their ability to do their job. They’re trying to save people’s lives and have a important and stressful job as it is.<br/>
					15. Hacking is your account’s responsibility. We don’t care who actually hacked, whether it was your brother, sister, neighbor, dad, your best friends mom, etc; its your account, take responsibility and keep it under your control.<br/>
					16. Any city town is a no fly zone, you can’t hover under 200m, If you want to land you must land in an open field out of the city/town limits.<br/>
					17. Combat logging is absolutely not allowed and is a bannable offense, and generally an obvious rule in most RP servers. If you have time to play, then you have time to wait for the respawn timer to end.<br/>
					18. Wearing any rebal gear/military gear is probable cause for detainment/search<br/>
					19. Side chat is only for advertising services and businesses, you have Mics, radios, and tablets to communicate. Offenders will be kicked and possibly banned.<br/>
					20. It is illegal for civ to be inside of the Police department fenced in area. It is considered a PD Restricted Zone. The lower floor of the bank is also considered this. It is illegal for you to be in the areas, and will be met with fines or in game jail time.<br/>
					21. Stealing a Police vehicle from the Police Department grounds is not allow, you will be met with lethal force.<br/>
					22. Any civ wearing masks or concealing their identity within the city limits is probable cause for the police to stop and search you.<br/>
					23. Police are cleared to use lethal force towards anyone who is a direct threat to themselves, or who is partaking in some of the following crimes: When your own or someone elses life is in direct danger, flying over prison, and flying over no fly zones (Will be met with 1 warning shot, then lethal force).<br/>
					24. Police have the rights to identity all occupants of a vehicle during a traffic stop (No Meta gaming) No use of mouse scroll must ask the civ for license and reg.<br/>
					25. Police does not have the ability to search random civs. They must have probable cause. Police are able to search an inventory of civ and vehicle if civ is taken into custody.<br/>
					26. Officers may restrain a civ up to an hour. This will allow them to do investigation and gather evidence on a crime they might have committed. A civ can also be restrained if the officer feels their live(s) may be in danger.<br/>
					27. Off duty officers while interacting with officers must identify themselves immediately that they’re an off duty officer.<br/>
					28. EMS are a neutral force, they don’t take sides.<br/>
					29. EMS are not allowed to revive players in a active firefight. Wait till it’s over.<br/>
					30. Teamspeak for cops are for cops only. If you need help with a admin or helpdesk go there don't go into the cop channel unless you're a cop.<br/>
					31. Cop weaponry - Cops can only carry tazers and pistols and will only be able to take a assault rifle only in a event of a bank heist or similar event. This must be issued and authorized by the highest ranking officer based on the situation.<br/>
					32. 'Merica. We drive on the right side of the road and follow those rules.<br/>
					33. Off-duty cops must roleplay as off-duty cops. Failure to do so may see suspension.<br/>
					34. Cop weaponry - Cops can only carry tazers and pistols and will only be able to take a assault rifle only in a event of a bank heist or similar event. This must be issued and authorized by the highest ranking officer based on the situation.<br/>
					35. Anyone outside the bank is not considered part of the robbery and if they kill it is RDM. ALL robbers must be INSIDE the bank.<br/>
					36. Cops cannot taze a vehicle full stop.
				"
		]
	];