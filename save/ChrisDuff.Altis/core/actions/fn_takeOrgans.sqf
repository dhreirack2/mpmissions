...
if(!([true,"kidney",1] call life_fnc_handleInv)) exitWith {hint "Vous n'avez pas assez de place!"};//if no room for kidney, you cannot take their kidney, duh, waste not want not
