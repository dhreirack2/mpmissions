...
_welcomeMessage = format["Bienvenue sur ChrisDuffLife %1 !",format["%1", name player]];
_camDistance = 40;
...
_role1 = "Bienvenue sur ChrisDuffLife";
_role1names = ["Altis Life RP"];
_role2 = "Site/Forum";
_role2names = ["ChrisDuff.Fr"];
_role3 = "TeamSpeak3";
_role3names = ["ts.chrisduff.fr"];
_role4 = "Important";
_role4names = ["Le Troll est strictement interdit ! Jouez RP !"];
_role5 = "Règles";
_role5names = ["Il est obligatoire de lire les règles disponible sur le Forum ! Merci bon jeu !"];

{
sleep 2;
_memberFunction = _x select 0;
_memberNames = _x select 1;
_finalText = format ["<t size='0.60' color='#aa0000' align='center'>%1<br /></t>", _memberFunction];
