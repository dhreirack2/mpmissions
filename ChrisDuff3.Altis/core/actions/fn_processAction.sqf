...
{
	case "oil": {["oilu","oilp",9999999999,(localize "STR_Process_Oil")];};
	case "diamond": {["diamond","diamondc",9999999999,(localize "STR_Process_Diamond")];};
	case "heroin": {["heroinu","heroinp",9999999999,(localize "STR_Process_Heroin")];};
	case "copper": {["copperore","copper_r",9999999999,(localize "STR_Process_Copper")];};
	case "iron": {["ironore","iron_r",9999999999,(localize "STR_Process_Iron")];};
	case "sand": {["sand","glass",9999999999,(localize "STR_Process_Sand")];};
	case "salt": {["salt","salt_r",9999999999,(localize "STR_Process_Salt")];};
	case "cocaine": {["cocaine","cocainep",9999999999,(localize "STR_Process_Cocaine")];};
	case "marijuana": {["cannabis","marijuana",9999999999,(localize "STR_Process_Marijuana")];};
	case "cement": {["rock","cement",9999999999,(localize "STR_Process_Cement")];};
	default {[];};
};
...
if(_hasLicense) then
{
	...
	_ui = "osefStatusBar" call BIS_fnc_rscLayer;_ui cutRsc["osefStatusBar","PLAIN"];//verrou de la barre de statut
}
	else
{
